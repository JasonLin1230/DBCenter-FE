...
<div class="page">
    ...
    <div class="login-form">
        ...
        <el-form
            ...
            <p class="desc">DBCenter是专为前端开发者提供的接口调用平台。可以本系统，添加数据表、数据表字段，通过相应的接口，完成对数据库增删改查的操作。点击查看<a href="https://github.com/wrz199306/DBCenter-BE" target="_blank">接口文档</a></p>
        </el-form>
    </div>
